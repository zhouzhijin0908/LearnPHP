133
a:4:{s:8:"template";a:1:{s:11:"./index.tpl";b:1;}s:9:"timestamp";i:1276695847;s:7:"expires";i:1276695847;s:13:"cache_serials";a:0:{}}<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
		...
		<div id="amendImageR">
			<div id="inputIfo">
				...
				<div class="handsetInformation">
					...
					<input type="hidden" name="photourl" id="uploadimgrect" value="">
					<input type="hidden" name="operate" id="operate">
					<input type="hidden" name="allianceid" id="allianceid" value="">
				</div>
				<div class="handsetInformation">
					3、彩信预览：
